...
skills/health/SKILL.md   ← Config health audit skill (six-layer framework)
skills/health/agents/     ← agent1-context.md, agent2-control.md (parallel analysis)
skills/health/references/ ← best-practices.md (Anthropic + community conventions)
skills/health/scripts/    ← collect.sh, parse_settings.py, validate.py
...
See [docs/experiments.md](docs/experiments.md) for model-upgrade experiment designs.
